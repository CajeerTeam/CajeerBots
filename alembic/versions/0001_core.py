...
def downgrade() -> None:
    for table in ["scheduled_jobs", "workspace_links", "user_profiles", "announcements", "moderation_actions", "support_tickets", "user_roles", "role_permissions", "roles", "platform_accounts", "users", "adapter_state", "audit_log", "idempotency_keys", "dead_letters", "delivery_queue", "event_bus", "platform_schema"]:
